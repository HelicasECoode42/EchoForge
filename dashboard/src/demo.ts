...
export const DEMO_GRAPH: GraphDefinition = {
  ...
  nodes: [
    ...
    { name: "verify_response", timeout_ms: 250, max_retries: 0 },
    { name: "persist_memory", timeout_ms: 5000, max_retries: 0 },
    { name: "complete", timeout_ms: 250, max_retries: 0 },
    { name: "blocked", timeout_ms: 250, max_retries: 0 },
    { name: "failed", timeout_ms: 250, max_retries: 0 },
  ],
  edges: [
    ...
    { source: "execute_agent", target: "verify_response", label: "agent_observed", conditional: false },
    { source: "verify_response", target: "persist_memory", label: "response_verified", conditional: true },
    { source: "verify_response", target: "blocked", label: "verification_blocked", conditional: true },
    { source: "verify_response", target: "failed", label: "verification_failed", conditional: true },
...
export const DEMO_TRACES: GraphTrace[] = [
  {
    ...
    node_runs: [
      ...
      { node: "verify_response", attempt: 1, status: "completed", latency_ms: 0.4, error_type: null },
    ...
    transitions: [
      ...
      { source: "execute_agent", target: "verify_response", label: "agent_observed" },
      { source: "verify_response", target: "persist_memory", label: "response_verified" },
      { source: "persist_memory", target: "complete", label: "memory_persisted" },
    ],
    stop_reason: "completed",
    total_latency_ms: 878.5,
    node_timings_ms: {
      load_memory: 31.8,
